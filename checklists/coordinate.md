...
1. Вижте [как от разстояние (по интернет) да обясните проблем или идея](#o-expression)?
...
<a id="o-expression">Как от разстояние (по интернет) да обясните проблем или идея</a>
- shared docs
- team viewer and the like
- https://screentogif.codeplex.com/ , byzanz and so on

<a id="o-otheruseful"></a>

## Други полезни online инструменти и похвати
5
 - Ако хората от екипа сте се разбрали че ще ползвате facebook, то групите там имат опцията за анкета. Може да я ползвате, за да се разберете за дата и час на среща или взимане на решения
